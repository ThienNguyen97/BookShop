...
<form class='w3-container' method="POST">
    <label class="w3-text-indigo"><strong>ID danh mục:</strong></label>
    <input class="w3-input"type="number" name="idDM" value="<?php echo($row_te['idDM']);?>"><br>
    <label class="w3-text-indigo"><strong>Giá tiền:</strong></label>
    <input class="w3-input"type="text" name="gia" value="<?php echo($row_te['gia']);?>"><br>
    <label class="w3-text-indigo"><strong>Mô tả:</strong></label><br>
